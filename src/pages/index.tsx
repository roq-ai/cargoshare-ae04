  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to CargoShare - Your Gateway to Cost-Effective, Sustainable Shipping. We connect truck drivers with spare cargo space to businesses in need, promoting environmental sustainability and maximizing logistic efficiency. Experience the future of freight today."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to CargoShare - Your Gateway to Cost-Effective, Sustainable Shipping. We connect truck drivers with spare cargo space to businesses in need, promoting environmental sustainability and maximizing logistic efficiency. Experience the future of freight today.`}
            </Text>
            <Box
